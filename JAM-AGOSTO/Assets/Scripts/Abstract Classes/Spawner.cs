...
public abstract class Spawner : MonoBehaviour
{
    ...
    [SerializeField]
    private float spawnerInterval = 1f; //Cantidad de turnos [WIP] // El intervalo de tiempo entre la generación de objetos
    ...
    public Vector3Int gridPos; // Posición del spawner en la grid 
